...
export const Message: MessageFns<Message> = {
  encode(message: Message, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.fromUser !== undefined) {
      writer.uint32(66).string(message.fromUser);
    }
    if (message.fromPhoto !== undefined) {
      writer.uint32(74).string(message.fromPhoto);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.fromPhoto = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Message {
    return {
      ...
      fromUser: isSet(object.fromUser) ? globalThis.String(object.fromUser) : undefined,
      fromPhoto: isSet(object.fromPhoto) ? globalThis.String(object.fromPhoto) : undefined,
    };
  },
  ...
  toJSON(message: Message): unknown {
    ...
    if (message.fromPhoto !== undefined) {
      obj.fromPhoto = message.fromPhoto;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Message>, I>>(object: I): Message {
    ...
    message.fromUser = object.fromUser ?? undefined;
    message.fromPhoto = object.fromPhoto ?? undefined;
    return message;
  },
};
...
function createBaseContentMarkAsReadResponse(): ContentMarkAsReadResponse {
  return { convid: "", to: 0, unread: 0, read: false, from: 0 };
}
